...
Elm.Dot = Elm.Dot || {};
Elm.Dot.make = function (_elm) {
   "use strict";
   _elm.Dot = _elm.Dot || {};
   if (_elm.Dot.values)
   return _elm.Dot.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.Pad = Elm.Pad || {};
Elm.Pad.make = function (_elm) {
   "use strict";
   _elm.Pad = _elm.Pad || {};
   if (_elm.Pad.values)
   return _elm.Pad.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var config = Elm.Native.Port.make(_elm).inbound("config",
   "{ id : Dot.ID, radius : Float, color : Dot.RGBA }",
   function (v) {
      return typeof v === "object" && "id" in v && "radius" in v && "color" in v ? {_: {}
                                                                                   ...
                                                                                   ,color: typeof v.color === "object" && "red" in v.color && "green" in v.color && "blue" in v.color && "alpha" in v.color ? {_: {}
                                                                                                                                                                                                              ,red: typeof v.color.red === "number" ? v.color.red : _U.badPort("a number",
                                                                                                                                                                                                              v.color.red)
                                                                                                                                                                                                              ,green: typeof v.color.green === "number" ? v.color.green : _U.badPort("a number",
                                                                                                                                                                                                              v.color.green)
                                                                                                                                                                                                              ,blue: typeof v.color.blue === "number" ? v.color.blue : _U.badPort("a number",
                                                                                                                                                                                                              v.color.blue)
                                                                                                                                                                                                              ,alpha: typeof v.color.alpha === "number" ? v.color.alpha : _U.badPort("a number",
                                                                                                                                                                                                              v.color.alpha)} : _U.badPort("an object with fields \'red\', \'green\', \'blue\', \'alpha\'",
                                                                                   v.color)} : _U.badPort("an object with fields \'id\', \'radius\', \'color\'",
      v);
   });
   var toCartesian = F3(function (w,
   h,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var fy = $Basics.toFloat(_v0._1);
                 var fx = $Basics.toFloat(_v0._0);
                 var dy = F2(function (x,y) {
                    return x * y;
                 })(0.5)($Basics.toFloat(h));
                 var dx = F2(function (x,y) {
                    return x * y;
                 })(0.5)($Basics.toFloat(w));
                 return {ctor: "_Tuple2"
                        ,_0: fx - dx
                        ,_1: 0 - (fy - dy)};
              }();}
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 c.green,
                 c.blue,
                 c.alpha))(A2($Graphics$Collage.rect,
   ...
   var touchToAction = F2(function (_v8,
   touch) {
      return function () {
         switch (_v8.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 x = $._0,
                 y = $._1;
                 return _U.eq(x,x0) && _U.eq(y,
                 y0) ? Add(A5($Dot.Dot,
                 config.id,
                 x,
                 y,
                 config.radius,
                 config.color)) : Move({ctor: "_Tuple2"
                                       ,_0: config.id
                                       ,_1: {ctor: "_Tuple2"
                                            ,_0: x
                                            ,_1: y}});
   ...
   var touchesToPoint = F2(function (_v12,
   touchs) {
      return function () {
         switch (_v12.ctor)
         {case "_Tuple2":
            return function () {
                 var _v16 = $List.head(touchs);
                 switch (_v16.ctor)
                 {case "Just":
                    return A2(touchToAction,
                      {ctor: "_Tuple2"
                      ,_0: _v12._0
                      ,_1: _v12._1},
                      _v16._0);
   ...
   var pointActions = A3($Signal.map2,
   touchesToPoint,
   $Window.dimensions,
   $Touch.touches);
   var movePoint = Elm.Native.Port.make(_elm).outboundSignal("movePoint",
   function (v) {
      return [v._0
             ,[v._1._0,v._1._1]];
   },
   function () {
      var takeMove = function (action) {
         return function () {
            switch (action.ctor)
            {case "Move":
   ...
   var removePoint = Elm.Native.Port.make(_elm).outboundSignal("removePoint",
   function (v) {
      return v;
   },
   function () {
      var takeRemove = function (action) {
         return function () {
            switch (action.ctor)
            {case "Remove":
               return $Maybe.Just(action._0);}
            return $Maybe.Nothing;
         }();
      };
      return A3($Signal.filterMap,
   ...
   var initialDot = A5($Dot.Dot,
   config.id,
   0.0,
   0.0,
   config.radius,
   config.color);
   var addPoint = Elm.Native.Port.make(_elm).outboundSignal("addPoint",
   function (v) {
      return {id: v.id
             ,x: v.x
             ,y: v.y
   ...
   _elm.Pad.values = {_op: _op
                     ...
                     ,touchToAction: touchToAction
                     ,touchesToPoint: touchesToPoint
